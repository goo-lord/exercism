...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    if temperature < 800.0 and neutrons_emitted > 500.0 and temperature* neutrons_emitted < 500000.0:
        return True
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if calculated_efficiency >= 80:
        return 'green'
    elif calculated_efficiency < 80 and calculated_efficiency >= 60:
        return 'orange'
    elif calculated_efficiency < 60 and calculated_efficiency >= 30:
        return 'red'
    else: return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if actual < 0.9 * threshold :
        return 'LOW'
    elif actual <= 1.1 * threshold:
        return 'NORMAL'
    else:
        return 'DANGER'