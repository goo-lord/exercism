...
def exchange_money(budget, exchange_rate):
    ...
    """
    estimated_value: float = budget / exchange_rate
...
def get_change(budget, exchanging_value):
    ...
    currency_left: float = budget - exchanging_value
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    total_value: int = denomination * number_of_bills
    return total_value
...
def get_leftover_of_bills(amount, denomination):
    ...
    leftover_bills: float = amount % denomination
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    return (math.floor(exchanged / denomination)) * denomination